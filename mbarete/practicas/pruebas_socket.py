...
class object_servidor(object_prueba):
    ...
    def __init__(self,puerto=8080,host='0.0.0.0',name='cross',**kwargs):
        super(object_servidor, self).__init__(**kwargs)
        import socket,json
...
class nodo_python(object_servidor):
    ...
    def __init__(self,IP_clase_C='192.168.100.',dispositivos='1-30',**kwargs):
        super(nodo_python, self).__init__(**kwargs)
        self.action_close=b'CLOSE\r\n'
        self.IP_C=IP_clase_C
        self.dispositivos=dispositivos
        #self.code=format_encode
        self.media=self.media_me(self.pwd)
        self.clients = {}
        self.scan()
...
def hijo_web():
    web=servidor_web(
        pwd=os.getcwd()+'/mbarete/media/servidor/',
        puerto=666,
...
def nodo():
    ...
    reloj=['~',r'\ ','|','/','~',r'\ ','|','/']
    x=7
    n=nodo_python(dispositivos='6-8',ignore=[21],puerto=666,name='cross',flags=['init','metodo','error'],pwd='/home/mbarete/Escritorio/0_PYTHON/Mbarete/mbarete/practicas')
...
if 'main' in __name__:
    ...
    pruebas={           
        ...
        5:{'titulo':"Servidor web 2.0",'f':hijo_web}
        }
