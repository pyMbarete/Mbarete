...
def escalarHex(h="#ffffff",factor=1.0):
    ...
    RR=float((escala[h[1:3][0]])*16+(escala[h[1:3][1]]))
    GG=float((escala[h[3:5][0]])*16+(escala[h[3:5][1]]))
    BB=float((escala[h[5:][0]])*16+(escala[h[5:][1]]))
    RR= int(RR*factor if RR*factor <=255.0 else RR )
    GG= int(GG*factor if GG*factor <=255.0 else GG )
    BB= int(BB*factor if BB*factor <=255.0 else BB )
