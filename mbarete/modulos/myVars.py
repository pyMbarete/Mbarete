...
inputsDefault={ k:v for k,v in inputsDefault.items() if v!=None }
for k in inputsDefault:
    inputsDefault[k] = {**atributos_default_style,**inputsDefault[k]}
